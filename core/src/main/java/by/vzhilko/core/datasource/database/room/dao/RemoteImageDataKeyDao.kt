...
import by.vzhilko.core.datasource.database.room.entity.REMOTE_IMAGE_DATA_KEY_TABLE_ID_FIELD_NAME
...
interface RemoteImageDataKeyDao {
    ...
    @Query("SELECT * FROM $REMOTE_IMAGE_DATA_KEY_TABLE_NAME WHERE $REMOTE_IMAGE_DATA_KEY_TABLE_ID_FIELD_NAME = :id")
